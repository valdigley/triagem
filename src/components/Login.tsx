                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  {loginError && !isRegisterMode && (
                    <div className={`border rounded-lg p-3 ${
                      loginError.includes('E-mail não confirmado') 
                          ...
                          <div className={`mt-1 text-sm ${
                            ...
                            {loginError.includes('E-mail não confirmado') && (
                              <div className="mt-2 space-y-1">
                                <p className="font-medium">📧 Passos para confirmar:</p>
                                <ol className="list-decimal list-inside space-y-1 text-xs">
                                  <li>Verifique sua caixa de entrada</li>
                                  <li>Procure também na pasta de spam/lixo eletrônico</li>
                                  <li>Clique no link de confirmação do Supabase</li>
                                  <li>Volte aqui e faça login novamente</li>
                                </ol>
                              </div>
                            )}
                          </div>
