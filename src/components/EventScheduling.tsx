...
const EventScheduling: React.FC<EventSchedulingProps> = ({ onBack }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Aviso de configuração de pagamento */}
      {(!paymentMethods.pix && !paymentMethods.creditCard && 
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-yellow-700">
                <p>
                  Para criar agendamentos, você precisa configurar pelo menos um método de pagamento.
                  Vá para <strong>Configurações → Pagamentos</strong> e configure:
                </p>
                <ul className="list-disc list-inside mt-2 space-y-1">
                  <li>PIX (ativado por padrão)</li>
                  <li>Cartão de Crédito (ativado por padrão)</li>
                  <li>Mercado Pago (requer credenciais)</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div className="flex items-start">
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-blue-700">
              <p><strong>Pacote mínimo:</strong> 10 fotos por R$ {minimumPackagePrice.toFixed(2)}</p>
              <p><strong>Pagamento antecipado:</strong> {advancePaymentPercentage}% (R$ {(minimumPackagePrice * advancePaymentPercentage / 100).toFixed(2)})</p>
              <p className="mt-1 text-xs">
                O cliente pagará antecipadamente e poderá selecionar até 10 fotos. 
                Fotos extras serão cobradas separadamente com desconto progressivo.
              </p>
            </div>
          </div>
        </div>
